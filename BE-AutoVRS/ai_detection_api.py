...
class AdvancedAIService:
    ...
    def initialize_pipeline(self):
        """Initialize the Inspection Pipeline with config."""
        try:
            logger.info("🚀 Initializing AOI Inspection Pipeline...")
    ...
    def format_results(self, inspection_results: List[InspectionResult], image: np.ndarray):
        ...
        if any(r.verdict == "NG" for r in inspection_results):
